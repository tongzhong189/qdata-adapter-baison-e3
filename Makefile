...
help: ## 显示帮助信息
	@echo "$(BLUE)BaisonE3Adapter - 开发工具$(NC)"
	@echo ""
...
test-cov: ## 运行测试（带覆盖率）
	pytest --cov=qdata_adapter_baison_e3 --cov-report=term-missing --cov-report=html
...
type-check: ## 类型检查
	mypy src/qdata_adapter_baison_e3
...
git-init: ## 初始化 Git 仓库
	...
	@echo "  git remote add origin https://github.com/qeasy/qdata-adapter-baison-e3.git"
...
git-first-commit: ## 初次提交（初始化Git并提交）
	...
	@echo "  2. git remote add origin https://github.com/YOUR_USERNAME/qdata-adapter-baison-e3.git"
